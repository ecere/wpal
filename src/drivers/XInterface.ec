...
static RootWindow restrictedWindow = null;
...
static RootWindow acquiredInputWindow;
...
bool XGetBorderWidths(RootWindow window, Box box)
{
...
default:
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyHit;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyUp;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyDown;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyHit;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMouseMove;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftDoubleClick;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftButtonDown;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftButtonUp;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleDoubleClick;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleButtonDown;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleButtonUp;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightDoubleClick;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightButtonDown;
extern int __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightButtonUp;
private:

static bool ProcessKeyMessage(RootWindow window, uint keyCode, int release, XKeyEvent * event)
{
   bool result = true;
   Key code;
   unichar ch = 0;
...
*/
   ...
   if(release == 1)
   {
      ...
      result = window.KeyMessage(__eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyUp, code, ch);
   }
   else
   {
      int c;
         ...
         if(windowData.ic && buflength)
         {
            for(c = 0; c<buflength;)
            {
               ...
               result = window.KeyMessage((c == 0) ?
                  __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyDown : __eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyHit,
                  (c == 0) ? code : 0, ch);
               c += numBytes;
            ...
            result = window.KeyMessage(__eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyDown, code, ch);
      }
      else if(key<128)
      {
         if(buflength && windowData.ic)
            for(c = 0; c<buflength;)
            {
               ...
               ch = UTF8GetChar(buf + c, &numBytes);
               if(ch == 127) ch = 0;
               result = window.KeyMessage(__eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyHit, code, ch);
               c += numBytes;
               if(!numBytes) c = buflength;
            }
         else
...
static void WaitForViewableWindow(RootWindow window)
{
   //int attempts = 0;
...
static bool GetFrameExtents(RootWindow window, bool update)
{
   XWindowData windowData = window.windowData;
   bool result = false;
   int format;
       ...
       &fill, &data) == Success && data)
   {
      ...
      if(!hadFrameExtents || extents[0] || extents[1] || extents[2] || extents[3])
      {
         ...
         if(update && change && ((RootWindow)window).clientSize.w > 0)
         {
...
static bool WaitForFrameExtents(RootWindow window, bool update)
{
   int attempts = 0;
   //XFlush(xGlobalDisplay);
   while(attempts++ < 40)
...
static void X11UpdateState(RootWindow window, bool * unmaximized)
{
...
class XInterface : Interface
{
   ...
   bool Initialize()
   {
      ...
      guiApp.xGlobalDisplay = xGlobalDisplay;
...
//*      XLockDisplay(xGlobalDisplay);
         ...
         if(window)
         {
            ...
            switch(thisEvent->type)
            {
               case KeyPress:
               {
                  ...
                  if(!window.active)
                  {
                     RootWindow modalRoot = window.FindModal();
               ...
               case ButtonPress:
               {
                  ...
                  static RootWindow lastWindow[3];
                  ...
                  if(event->button == Button1)
                  {
                     ...
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftButtonDown;
                     buttonDouble = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftDoubleClick;
                     whichButton = 0;
                  ...
                  {
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightButtonDown;
                     buttonDouble = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightDoubleClick;
                     whichButton = 2;
                  ...
                  {
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleButtonDown;
                     buttonDouble = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleDoubleClick;
                     whichButton = 1;
                  ...
                  {
                     window.KeyMessage(__eCVMethodID___eCNameSpace__wpal__RootWindow_OnKeyHit, { modifiers = keyFlags, code = (event->button == Button4) ? wheelUp : wheelDown }, 0);
                  }
                  else if(button)
                  {
                     if(doubleClick)
               ...
               case ButtonRelease:
               {
                  ...
                  if(event->button == Button1)
                  {
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnLeftButtonUp;
                     buttonMask = Button1Mask;
                     buttonsState.left = false;
                  }
                  else if(event->button == Button3)
                  {
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnRightButtonUp;
                     buttonMask = Button3Mask;
                     buttonsState.right = false;
                  }
                  else
                  {
                     button = __eCVMethodID___eCNameSpace__wpal__RootWindow_OnMiddleButtonUp;
                     buttonMask = Button2Mask;
               ...
               case MotionNotify:
               {
                  ...
                  // if(event->time - lastTime > 15)
                  {
                     ...
                     window.MouseMessage(__eCVMethodID___eCNameSpace__wpal__RootWindow_OnMouseMove,
                     ...
                     else
                     {
                        ...
                        //if(event->send_event)
                        {
                           ...
                           XTranslateCoordinates(xGlobalDisplay, event->window,
                              // Review RootWindow vs. XRootWindow?
                              XRootWindow(xGlobalDisplay, DefaultScreen(xGlobalDisplay)), 0, 0,
   ...
   void Lock(RootWindow window)
   {
      //*XLockDisplay(xGlobalDisplay);
   }

   void Unlock(RootWindow window)
   {
      //*XUnlockDisplay(xGlobalDisplay);
   }
   ...
   // --- RootWindow Creation ---
   void * CreateRootWindow(RootWindow window)
   {
      X11Window windowHandle;
      XSetWindowAttributes attributes = { 0 };
      XVisualInfo * visualInfo = window.xVisualInfo;
      int depth;
      Visual * visual;
      XIC ic = null;
      ...
      */
      else
      {
         ...
         else
         {
            ...
            {
               RootWindow master = window.master;
               RootWindow rootWindow = master.rootWindow;

               parentWindow = (X11Window)rootWindow.windowHandle;
      ...
      */
      ...
      // XFlush(xGlobalDisplay);
      window.windowData = XWindowData { ic = ic };
   ...
   void DestroyRootWindow(RootWindow window)
   {
      XEvent event;
      if(window == acquiredInputWindow)
   ...
   void SetRootWindowCaption(RootWindow window, const char * name)
   {
      if(window.windowHandle)
      {
   ...
   void PositionRootWindow(RootWindow window, int x, int y, int w, int h, bool move, bool resize)
   {
      //Logf("Position root window %s\n", window.name);
      if(window.windowHandle && (!window.parent /* REVIEW: || !window.parent.display*/))
      {
   ...
   void OrderRootWindow(RootWindow window, bool topMost)
   {
      SetNETWMState((X11Window)window.windowHandle, false, topMost ? add : remove, atoms[_net_wm_state_above], 0);
   }

   void SetRootWindowColor(RootWindow window)
   {

   }

   void OffsetWindow(RootWindow window, int * x, int * y)
   {

   }

   void UpdateRootWindow(RootWindow window)
   {
      if(!window.parent /* REVIEW: || !window.parent.display*/)
      {
         if(window.visible)
         {
            Box box = window.box;
   ...
   void SetRootWindowState(RootWindow window, WindowState state, bool visible)
   {
      ...
      *&window.state = state;
      ...
      if(!atomsSupported[_net_wm_state])
         window.nativeDecorations = false;
      if(!window.parent || window == window.rootWindow) /* REVIEW: || !window.parent.display*/
      {
            ...
            else if(!fullScreenMode)
            {
               ...
               if(atomsSupported[_net_wm_state])
               {
                  ...
                  if(state == maximized)
                  {
                     ...
                     // if the RootWindow Manager hasn't set the hints yet.
                     XFlush(xGlobalDisplay);
                     Sleep(0.01);
                  }
               }
   ...
   void FlashRootWindow(RootWindow window)
   {
      void * hwnd = window.windowHandle;
      RootWindow master = window.master, rootWindow = (master && master != guiApp.desktop) ? master.rootWindow : null;
   ...
   void ActivateRootWindow(RootWindow window)
   {
      if(!window.parent || window.rootWindow == window)
      {
...
//#endif
   ...
   void StartMoving(RootWindow window, int x, int y, bool fromKeyBoard)
   {

   }

   void StopMoving(RootWindow window)
   {
   ...
   void SetMouseRange(RootWindow window, Box box)
   {
      ((GuiApplication)__thisModule.application).Lock();
      //XLockDisplay(xGlobalDisplay);
   ...
   void SetMouseCapture(RootWindow window)
   {
      //*XLockDisplay(xGlobalDisplay);
      if(window)
      {
   ...
   void SetMouseCursor(RootWindow window, int cursor)
   {
   ...
   {
      RootWindow caretOwner = guiApp.caretOwner;
      RootWindow window = caretOwner ? caretOwner.rootWindow : null;
   ...
   bool SaveClipboard(ClipBoard clipBoard)
   {
      ...
      if(clipBoard.text)
      {
         RootWindow rootWindow = guiApp.desktop;
         if(!fullScreenMode)
         {
   ...
   bool AcquireInput(RootWindow window, bool state)
   {
      if(state && window)
      {
   ...
   /* REVIEW:
   bool SetIcon(RootWindow window, BitmapResource resource)
   {
      if(resource)
      {
         Bitmap bitmap { };
...
// REVIEW: Except for the rootWindow check, this functionality is provided by RootWindow::systemHandle
default dllexport void * IS_XGetWindow(RootWindow window)
{
